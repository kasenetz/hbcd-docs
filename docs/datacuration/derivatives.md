...
[Infant-fMRIPrep](#infant-fmriprep-nibabies) intermediate pipeline outputs include folders generated by FreeSurfer and MCRIBS for surface reconstruction. These are included in the data release within the `freesurfer/` and `mcribs/` folders.
