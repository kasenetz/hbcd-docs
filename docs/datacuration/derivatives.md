...
## FreeSurfer & MCRIBS - ⚠️ UNDER CONSTRUCTION ⚠️
FreeSurfer outputs generated by [Infant-fMRIPrep](#infant-fmriprep-nibabies) are also included in the data release within the folder `freesurfer/` and `mcribs/`. These are intermediate pipeline outputs.
...
|__ <span class="subses">SUBSES</span>
    ...
    |           |__ cerebrum-<span class="placeholder">&lt;1|2|3&gt;</span>-dmap.nii.gz
    ...
    |           |__ corpus-callosum-mask-<span class="placeholder">#</span>.nii.gz
