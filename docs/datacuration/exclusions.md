...
For structural MRI, in cases where multiple T1w and/or T2w images were acquired that passed QC, only the best T1w and T2w were selected for processing and thus included in the raw BIDS data provided in the release.
