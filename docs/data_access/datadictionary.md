...
Note that warning labels are included next to relevant Variables and Tables; these link directly to Responsible Use & Expert Review warnings provided in the release notes - see [here](resp_data_use.md#warnings) for details. 
